...
INSERT INTO public.question (id, version, correctanswer, duration, explanation, firstanswer, fourthanswer, label, number, secondanswer, thirdanswer, quiz_id) VALUES (7, 0, 2, 20, 'Avec l''argent qu''ils ont dépensé le contraire aurait été grave', 'Marseille', 'Monaco', 'Qui a gagné le championnat de France pour la saison 2012/2013', 3, 'Paris', 'Lyon', 3);
