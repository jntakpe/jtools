...
INSERT INTO public.question (id, version, correctanswer, duration, explanation, firstanswer, fourthanswer, label, number, secondanswer, thirdanswer, quiz_id) VALUES (2, 0, 4, 30, 'Si aucun constructeur n''est d�fini la JVM en cr��ra un par d�faut. Ensuite, on peut en cr�er autant que l''on souhaite', '1', '0 ou plusieurs', 'Combien de constructeur peut-on d�finir pour une classe ?', 1, '0 ou 1', '1 ou plusieurs', 1);
INSERT INTO public.question (id, version, correctanswer, duration, explanation, firstanswer, fourthanswer, label, number, secondanswer, thirdanswer, quiz_id) VALUES (3, 0, 1, 40, 'L''h�ritage multiple n''est pas support� en Java mais on peut impl�menter plusieurs interfaces', 'Une classe peut impl�menter plusieurs interfaces mais doit �tendre une seule classe ', 'Une classe doit impl�menter une seule interface et �tendre une seule classe', 'Quelle proposition est la bonne ?', 2, 'Une classe peut impl�menter plusieurs classes mais doit �tendre une seule interface ', 'Une classe peut impl�menter plusieurs classes et peut �tendre plusieurs interfaces', 1);
INSERT INTO public.question (id, version, correctanswer, duration, explanation, firstanswer, fourthanswer, label, number, secondanswer, thirdanswer, quiz_id) VALUES (4, 0, 2, 30, 'Le garbage collector passe quand la heap memory est presque pleine', 'il peut engendrer une fuite m�moire', '', 'Lorsqu''un objet n''est plus r�f�renc� ...', 3, 'il peut d�truit ou non, c''est au bon vouloir de la JVM', 'il imm�diatement d�truit par la JVM', 1);
INSERT INTO public.question (id, version, correctanswer, duration, explanation, firstanswer, fourthanswer, label, number, secondanswer, thirdanswer, quiz_id) VALUES (5, 0, 2, 20, '10 joueurs de champ + 1 goal', '10', '13', 'Combien de joueurs il y a t-il sur le terrain pour chaque �quipe', 0, '11', '12', 3);
INSERT INTO public.question (id, version, correctanswer, duration, explanation, firstanswer, fourthanswer, label, number, secondanswer, thirdanswer, quiz_id) VALUES (6, 0, 3, 20, 'L''ancien nom �tait 1�re division', '1�re division', 'Pro ligue', 'Comment s''appelle le championnat de France de football', 1, 'Top14', 'Ligue 1', 3);
INSERT INTO public.question (id, version, correctanswer, duration, explanation, firstanswer, fourthanswer, label, number, secondanswer, thirdanswer, quiz_id) VALUES (7, 0, 2, 20, 'Avec l''argent qu''ils ont d�pens� le contraire aurait �t� grave', 'Marseille', 'Monaco', 'Qui a gagn� le championnat de France pour la saison 2012/2013', 2, 'Paris', 'Lyon', 3);
...
INSERT INTO public.question (id, version, correctanswer, duration, explanation, firstanswer, fourthanswer, label, number, secondanswer, thirdanswer, quiz_id) VALUES (9, 0, 3, 20, 'James Cameron est le r�alisateur de Titanic', 'ET', 'Minority Report', 'Quel film n''a r�alis� Steven Spielberg', 0, 'Il faut sauver le soldat Ryan', 'Titanic', 2);
INSERT INTO public.question (id, version, correctanswer, duration, explanation, firstanswer, fourthanswer, label, number, secondanswer, thirdanswer, quiz_id) VALUES (10, 0, 2, 20, 'Will Smith a refus� le r�le de Django', 'Men in black', 'Ali', 'Dans lequel de ces films Will Smith n''a pas jou�', 1, 'Django unchained', 'Independance day', 2);
INSERT INTO public.question (id, version, correctanswer, duration, explanation, firstanswer, fourthanswer, label, number, secondanswer, thirdanswer, quiz_id) VALUES (11, 0, 1, 20, 'Bah ouais', 'La guerre des mondes', '', 'Dans quel film Bruce Willis n''a pas sauv� le monde', 2, 'Le cinqui�me �l�ment', 'Armageddon', 2);
...
INSERT INTO public.movie (id, version, title, director, addedby_id, adddate, josssawit, jujupiwisawit, selraksawit, ameliasawit, ratings) VALUES (3, 0, 'A la recherche du bonheur', 'Gabriele Muccino', 2, '2013-05-13', TRUE, TRUE, TRUE, FALSE, 9);
